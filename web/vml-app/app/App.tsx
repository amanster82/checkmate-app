...
function app() {
    ...
    const returnEvents = () => {
        ...
        return eventsData.map((event) => (
            ...
            <Card interactive={true} elevation={Elevation.TWO} className='event-card'>
                <div className='event-header'>
                    <h1>{event.title}</h1>
                </div>
                <div style={{ textAlign: 'right' }}>
                    <Button icon="cog" text="Settings" className={Classes.BUTTON} onClick={() => setIsOpen(true)} />
                </div>
            </Card>
    ...
    return (
        <>
            ...
            <Card className="create-event" interactive={hasMembershipFile} elevation={Elevation.TWO} onClick={() => setIsOpen(true)}>
